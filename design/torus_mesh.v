...
//========================================
//New Torus wrap-around wires
//========================================

//----------------------------------------
//East-West wrap
//----------------------------------------
//node03 east <-> node00 west
wire ew_si_03_00, ew_ri_03_00; wire [63:0] ew_di_03_00; // node03 -> node00 westward wrap
wire we_si_00_03, we_ri_00_03; wire [63:0] we_di_00_03; // node00 -> node03 eastward wrap
//node13 east <-> node10 west
wire ew_si_13_10, ew_ri_13_10; wire [63:0] ew_di_13_10; // node13 -> node10 westward wrap
wire we_si_10_13, we_ri_10_13; wire [63:0] we_di_10_13; // node10 -> node13 eastward wrap
//node23 east <-> node20 west
wire ew_si_23_20, ew_ri_23_20; wire [63:0] ew_di_23_20; // node23 -> node20 westward wrap
wire we_si_20_23, we_ri_20_23; wire [63:0] we_di_20_23; // node20 -> node23 eastward wrap
//node33 east <-> node30 west
wire ew_si_33_30, ew_ri_33_30; wire [63:0] ew_di_33_30; // node33 -> node30 westward wrap
wire we_si_30_33, we_ri_30_33; wire [63:0] we_di_30_33; // node30 -> node33 eastward wrap

//----------------------------------------
//North-South wrap
//----------------------------------------
//node00 north <-> node30 south
wire ns_si_00_30, ns_ri_00_30; wire [63:0] ns_di_00_30; // node00 -> node30 northward wrap
wire sn_si_30_00, sn_ri_30_00; wire [63:0] sn_di_30_00; // node30 -> node00 southward wrap
//node01 north <-> node31 south
wire ns_si_01_31, ns_ri_01_31; wire [63:0] ns_di_01_31; // node01 -> node31 northward wrap
wire sn_si_31_01, sn_ri_31_01; wire [63:0] sn_di_31_01; // node31 -> node01 southward wrap
//node02 north <-> node32 south
wire ns_si_02_32, ns_ri_02_32; wire [63:0] ns_di_02_32; // node02 -> node32 northward wrap
wire sn_si_32_02, sn_ri_32_02; wire [63:0] sn_di_32_02; // node32 -> node02 southward wrap
//node03 north <-> node33 south
wire ns_si_03_33, ns_ri_03_33; wire [63:0] ns_di_03_33; // node03 -> node33 northward wrap
wire sn_si_33_03, sn_ri_33_03; wire [63:0] sn_di_33_03; // node33 -> node03 southward wrap
...
gold_router router00 (
    ...
    // North - boundary, to node30
    .nsi(sn_si_30_00), .nri(sn_ri_30_00), .ndi(sn_di_30_00),
    .nso(ns_si_00_30), .nro(ns_ri_00_30), .ndo(ns_di_00_30),
    ...
    // West - boundary, to node03
    .wsi(ew_si_03_00), .wri(ew_ri_03_00), .wdi(ew_di_03_00),
    .wso(we_si_00_03), .wro(we_ri_00_03), .wdo(we_di_00_03),
    // PE
...
gold_router router01 (
    ...
    // North - boundary, to node31
    .nsi(sn_si_31_01), .nri(sn_ri_31_01), .ndi(sn_di_31_01),
    .nso(ns_si_01_31), .nro(ns_ri_01_31), .ndo(ns_di_01_31),
...
gold_router router02 (
    ...
    // North - boundary, to node32
    .nsi(sn_si_32_02), .nri(sn_ri_32_02), .ndi(sn_di_32_02),
    .nso(ns_si_02_32), .nro(ns_ri_02_32), .ndo(ns_di_02_32),
...
gold_router router03 (
    ...
    // North - boundary, to node33
    .nsi(sn_si_33_03), .nri(sn_ri_33_03), .ndi(sn_di_33_03),
    .nso(ns_si_03_33), .nro(ns_ri_03_33), .ndo(ns_di_03_33),
    // South - connects to node13
    .ssi(sn_si_13_03), .sri(sn_ri_13_03), .sdi(sn_di_13_03),
    .sso(ns_si_03_13), .sro(ns_ri_03_13), .sdo(ns_di_03_13),
    // East - boundary, to node00
    .esi(we_si_00_03), .eri(we_ri_00_03), .edi(we_di_00_03),
    .eso(ew_si_03_00), .ero(ew_ri_03_00), .edo(ew_di_03_00),
...
gold_router router10 (
    ...
    // West - boundary, to node13
    .wsi(ew_si_13_10), .wri(ew_ri_13_10), .wdi(ew_di_13_10),
    .wso(we_si_10_13), .wro(we_ri_10_13), .wdo(we_di_10_13),
    // PE
...
gold_router router13 (
    ...
    // East - boundary, to node10
    .esi(we_si_10_13), .eri(we_ri_10_13), .edi(we_di_10_13),
    .eso(ew_si_13_10), .ero(ew_ri_13_10), .edo(ew_di_13_10),
...
gold_router router20 (
    ...
    // West - boundary, to node23
    .wsi(ew_si_23_20), .wri(ew_ri_23_20), .wdi(ew_di_23_20),
    .wso(we_si_20_23), .wro(we_ri_20_23), .wdo(we_di_20_23),
    // PE
...
gold_router router23 (
    ...
    // East - boundary, to node 20
    .esi(we_si_20_23), .eri(we_ri_20_23), .edi(we_di_20_23),
    .eso(ew_si_23_20), .ero(ew_ri_23_20), .edo(ew_di_23_20),
...
gold_router router30 (
    ...
    // South - boundary, to node00
    .ssi(ns_si_00_30), .sri(ns_ri_00_30), .sdi(ns_di_00_30),
    .sso(sn_si_30_00), .sro(sn_ri_30_00), .sdo(sn_di_30_00),
    // East - connects to node31
    .esi(we_si_31_30), .eri(we_ri_31_30), .edi(we_di_31_30),
    .eso(ew_si_30_31), .ero(ew_ri_30_31), .edo(ew_di_30_31),
    // West - boundary, to node33
    .wsi(ew_si_33_30), .wri(ew_ri_33_30), .wdi(ew_di_33_30),
    .wso(we_si_30_33), .wro(we_ri_30_33), .wdo(we_di_30_33),
    // PE
...
gold_router router31 (
    ...
    // South - boundary, to node01
    .ssi(ns_si_01_31), .sri(ns_ri_01_31), .sdi(ns_di_01_31),
    .sso(sn_si_31_01), .sro(sn_ri_31_01), .sdo(sn_di_31_01),
...
gold_router router32 (
    ...
    // South - boundary, to node 02
    .ssi(ns_si_02_32), .sri(ns_ri_02_32), .sdi(ns_di_02_32),
    .sso(sn_si_32_02), .sro(sn_ri_32_02), .sdo(sn_di_32_02),
...
gold_router router33 (
    ...
    // South - boundary, to node03
    .ssi(ns_si_03_33), .sri(ns_ri_03_33), .sdi(ns_di_03_33),
    .sso(sn_si_33_03), .sro(sn_ri_33_03), .sdo(sn_di_33_03),
    // East - boundary, to node30
    .esi(we_si_30_33), .eri(we_ri_30_33), .edi(we_di_30_33),
    .eso(ew_si_33_30), .ero(ew_ri_33_30), .edo(ew_di_33_30),
